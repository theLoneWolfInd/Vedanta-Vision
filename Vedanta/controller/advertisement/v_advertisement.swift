...
class v_advertisement: UIViewController {
...
extension v_advertisement : UITableViewDelegate , UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:v_advertisement_table_cell = tableView.dequeueReusableCell(withIdentifier: "v_advertisement_table_cell") as! v_advertisement_table_cell
        ...
        cell.lbl_start_date.text = (item!["startDate"] as! String)
        cell.lbl_end_date.text = (item!["endDate"] as! String)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let pushVC = self.storyboard?.instantiateViewController(withIdentifier: "advertisement_details_id") as! advertisement_details
        
        pushVC.hidesBottomBarWhenPushed = false
        
        pushVC.str_img_advertisement = (item!["image"] as! String)
...
class v_advertisement_table_cell:UITableViewCell {
    ...
    @IBOutlet weak var img_view_list:UIImageView! {
        didSet {
            ...
            img_view_list.backgroundColor = .white
        }
    }
